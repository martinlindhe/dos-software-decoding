; Source demo-com-16bit/blaze/blaze4.com

[085F:0100] BFBF03           Mov16    di, 0x03BF                    ; di = 0x03BF
...
[085F:010B] BFB702           Mov16    di, 0x02B7                    ; di = 0x02B7
[085F:010E] B141             Mov8     cl, 0x41                      ; cl = 0x41
[085F:0110] E85701           CallNear 0x026A                        ; xref: branch@085F:0116
...
[085F:016D] 33ED             Xor16    bp, bp                        ; xref: jump@085F:025D; bp = 0x0000
[085F:016F] B143             Mov8     cl, 0x43                      ; xref: branch@085F:01BB; cl = 0x43
[085F:0171] BB3F06           Mov16    bx, 0x063F                    ; bx = 0x063F
[085F:0174] 01EB             Add16    bx, bp                        ; bx = 0x063F
...
[085F:01C4] BEFF04           Mov16    si, 0x04FF                    ; si = 0x04FF
...
[085F:01EC] 46               Inc16    si                            ; si = 0x0500
...
[085F:01FC] E86B00           CallNear 0x026A
...
[085F:0207] 81C59702         Add16    bp, 0x0297                    ; bp = 0x02D9
...
[085F:0234] 46               Inc16    si                            ; si = 0x0501
...
[085F:023D] 4D               Dec16    bp                            ; bp = 0x02D8
[085F:023E] 7592             Jnz      0x01D2
[085F:0240] 1E               Push16   ds
[085F:0241] 8CC0             Mov16    ax, es
[085F:0243] 8ED8             Mov16    ds, ax                        ; ds is dirty
[085F:0245] B800A0           Mov16    ax, 0xA000                    ; ax = 0xA000
[085F:0248] 8EC0             Mov16    es, ax                        ; es = 0xA000
[085F:024A] 33F6             Xor16    si, si                        ; si = 0x0000
[085F:024C] BF4001           Mov16    di, 0x0140                    ; di = 0x0140
[085F:024F] B9C07B           Mov16    cx, 0x7BC0                    ; cx = 0x7BC0
[085F:0252] F3A5             Rep      Movsw
[085F:0254] 1F               Pop16    ds                            ; ds is dirty
[085F:0255] B406             Mov8     ah, 0x06                      ; ah = 0x06
[085F:0257] B2FF             Mov8     dl, 0xFF                      ; dl = 0xFF
[085F:0259] CD21             Int      0x21                          ; dos: write character in DL to DIRECT CONSOLE OUTPUT | dirty all regs
[085F:025B] 7503             Jnz      0x0260
[085F:025D] E90DFF           JmpNear  0x016D

[085F:0260] B80300           Mov16    ax, 0x0003                    ; xref: branch@085F:025B; ax = 0x0003
[085F:0263] CD10             Int      0x10                          ; video: set 80x25 text mode (0x03) | dirty all regs
[085F:0265] B8004C           Mov16    ax, 0x4C00                    ; ax = 0x4C00
[085F:0268] CD21             Int      0x21                          ; dos: terminate program with return code in AL | dirty all regs

[085F:026A] 06               Push16   es                            ; xref: call@085F:0110, call@085F:01A8, call@085F:01FC
[085F:026B] 51               Push16   cx
[085F:026C] 56               Push16   si
[085F:026D] 1E               Push16   ds
[085F:026E] 07               Pop16    es                            ; es is dirty
[085F:026F] BE1301           Mov16    si, 0x0113                    ; si = 0x0113
[085F:0272] BFB702           Mov16    di, 0x02B7                    ; di = 0x02B7
[085F:0275] AD               Lodsw                                  ; ax = [ds:si]
[085F:0276] 8BD8             Mov16    bx, ax                        ; bx is dirty
[085F:0278] F76502           Mul16    word [ds:di+0x02]
[085F:027B] 89C1             Mov16    cx, ax                        ; cx is dirty
[085F:027D] AD               Lodsw                                  ; ax = [ds:si]
[085F:027E] F725             Mul16    word [ds:di]
[085F:0280] 03C8             Add16    cx, ax
[085F:0282] 93               Xchg16   ax, bx                        ; ax is dirty
[085F:0283] F725             Mul16    word [ds:di]
[085F:0285] 01CA             Add16    dx, cx
[085F:0287] 40               Inc16    ax                            ; ax = 0x0601
[085F:0288] 88F3             Mov8     bl, dh                        ; bl = 0x00
[085F:028A] 32FF             Xor8     bh, bh                        ; bh = 0x00
[085F:028C] 8787BB02         Xchg16   word [ds:bx+0x02BB], ax
[085F:0290] AB               Stosw                                  ; [es:di] = ax
[085F:0291] 8915             Mov16    word [ds:di], dx
[085F:0293] 5E               Pop16    si                            ; si is dirty
[085F:0294] 59               Pop16    cx                            ; cx is dirty
[085F:0295] 07               Pop16    es                            ; es is dirty
[085F:0296] C3               Retn
...
[085F:02A3] 0100FFFF         db       0x01, 0x00, 0xFF, 0xFF
[085F:02A7] 0100FFFF         db       0x01, 0x00, 0xFF, 0xFF
[085F:02AB] 4001C0FE         db       0x40, 0x01, 0xC0, 0xFE
[085F:02AF] 3F014101         db       0x3F, 0x01, 0x41, 0x01
[085F:02B3] C1FEBFFE         db       0xC1, 0xFE, 0xBF, 0xFE
