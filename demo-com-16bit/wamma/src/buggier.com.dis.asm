; Source demo-com-16bit/wamma/src/buggier.com
...
[085F:0269] B307             Mov8     bl, 0x07                      ; bl = 0x07
...
[085F:027B] B707             Mov8     bh, 0x07                      ; bh = 0x07
...
[085F:0295] 81C3FE00         Add16    bx, 0x00FE                    ; bx = 0x0805
[085F:0299] 43               Inc16    bx                            ; xref: branch@085F:0293; bx = 0x0806
...
[085F:02A1] FECF             Dec8     bh                            ; bh = 0x07
[085F:02A3] 79D8             Jns      0x027D
[085F:02A5] FECB             Dec8     bl                            ; bl = 0x05
...
[085F:02B2] C1F803           Sar16    ax, 0x03
...
[085F:02BD] C1F803           Sar16    ax, 0x03
